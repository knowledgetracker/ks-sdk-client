...
class CourseClient {
    ...
    save(course) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield axios_1.default.post(url, course, { headers: this.headers });
            return response.data;
        });
    }
    update(id, course) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //course["createdBy"] = createdBy;
            let url = `${this.API_URL}v1/courses/${id}`;
            let response = yield axios_1.default.put(url, course, { headers: this.headers });
            return response.data;
        });
    }
    delete(id) {
    ...
    addSection(courseId, section) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let url = `${this.API_URL}v1/courses/${courseId}/sections`;
            let response = yield axios_1.default.post(url, section, { headers: this.headers });
            return response.data;
        });
    }
    addLecture(courseId, lecture) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield axios_1.default.post(url, lecture, { headers: this.headers });
            return response.data;
        });
    }
    ...
    addTopic(courseId, moduleId, topic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield axios_1.default.post(url, topic, { headers: this.headers });
            return response.data;
        });
    }
    ...
    publish(courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield axios_1.default.put(url, null, { headers: this.headers });
            return response.data;
        });
    }
    importCourses(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield axios_1.default.post(url, file, { headers: this.headers });
            return response.data;
        });
    }
    ...
    updateContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield axios_1.default.put(url, content, { headers: this.headers });
            return response.data;
        });
    }
